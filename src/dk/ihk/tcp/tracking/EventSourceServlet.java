...
/**
 * <p>
 * A servlet that implements the <a
 * href="http://www.w3.org/TR/eventsource/">event source protocol</a>, also
 * known as "server sent events".
 * </p>
 * <p>
 * This servlet must be subclassed to implement abstract method
 * {@link #newEventSource(HttpServletRequest)} to return an instance of
 * {@link EventSource} that allows application to listen for event source events
 ...
 * </p>
 * <ul>
 * <li><code>heartBeatPeriod</code>, that specifies the heartbeat period, in
 * seconds, used to check whether the connection has been closed by the client;
 * defaults to 10 seconds.</li>
 * </ul>
 * 
 * <p>
		...
		while (acceptValues.hasMoreElements())
		{
			...
			if (accept.equals("text/event-stream"))
			{
				...
				else
				{
					...
					// Infinite timeout because the continuation is never
					// resumed,
